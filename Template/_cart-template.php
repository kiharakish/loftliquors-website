        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row border-top py-3 mt-3">
                    ...
                    <div class="col-sm-8">
                        <h5 class="font-baloo font-size-20">Johnnie Walker Black Label</h5>
                        <small>by Johnnie Walker</small>
                        <!-- product rating -->
                        <div class="d-flex">
                    ...
                    <div class="col-sm-2 text-right">
                        <div class="font-size-20 text-danger font-baloo">
                            $<span class="product_price">$25</span>
                        </div>
                    </div>
                </div>
                <!-- !cart item -->
                ...
                <div class="row border-top py-3 mt-3">
                    ...
                    <div class="col-sm-8">
                        <h5 class="font-baloo font-size-20">Napoleon Gold Whisky</h5>
                        <small>by london distilllers</small>
                        <!-- product rating -->
                        <div class="d-flex">
                            <div class="rating text-warning font-size-12">
                                <span><i class="fas fa-star"></i></span>
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        <h5 class="font-baloo font-size-20">Subtotal (2 item):&nbsp; <span class="text-danger">$<span class="text-danger" id="deal-price">10.00</span> </span> </h5>
